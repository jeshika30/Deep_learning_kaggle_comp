...
# Load test dataset
test_dict = unpickle(os.path.join(cifar_dir, "test_batch"))
...
# Define CIFARTestDataset
class CIFARTestDataset(Dataset):
    def __init__(self, images, indices, transform):
        self.images = images
...
test_dataset = CIFARTestDataset(test_images, test_indices, transform_val)
...
with open("training_log2.csv", "w", newline="") as f:
    ...
    for epoch in range(50):
        ...
        writer.writerow([epoch+1, running_loss/len(train_loader), train_accuracy, val_accuracy])
